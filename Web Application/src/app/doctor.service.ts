...
export class DoctorService {
  ...
  loginDoctor(userObj: any): Observable<any> {
    return this.httpClientObj.post(environment.SERVER_URL+"/doctor_login", userObj);
  }
  addDoctorToDatabase(userObj: any): Observable<any> {
    return this.httpClientObj.post(environment.SERVER_URL+"/doctor_signup", userObj);
  }
  ...
  getDoctorList(): Observable<any> {
    return this.httpClientObj.get<any>(environment.SERVER_URL+"/get_doctors")
  }
  getDoctorName(){
